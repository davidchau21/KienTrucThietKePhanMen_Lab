package com.example.springboot_api_jwt_ad.util;
...
public class JwtUtil {
    ...
    private static final String SECRET = "hey Mr Tien the secrect length must be at least 256 bít" + "please no reveal!";
